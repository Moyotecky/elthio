...
class FindDoctorsModel {
  Rx<List<FinddoctorsItemModel>> finddoctorsItemList = Rx([
    FinddoctorsItemModel(
        general: ImageConstant.imgUserPrimary.obs, general1: "General".obs),
    FinddoctorsItemModel(
        general: ImageConstant.imgIconLungs.obs, general1: "Lungs".obs),
    FinddoctorsItemModel(
        general: ImageConstant.imgIconDentist.obs, general1: "Dentist".obs),
    FinddoctorsItemModel(
        general: ImageConstant.imgSettings.obs, general1: "Covid-19".obs),
    FinddoctorsItemModel(
        general: ImageConstant.imgTrash.obs, general1: "Surgeon".obs),
    FinddoctorsItemModel(
        general: ImageConstant.imgBookmark.obs, general1: "Cardio".obs)
  ]);
